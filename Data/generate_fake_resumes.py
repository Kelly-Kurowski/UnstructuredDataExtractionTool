...
occupations = [
    ...
    "RPA Developer", "Data Resume Engineer", "Software Developer", "UX/UI Designer", "Product Manager",
    "Financial Analyst", "Human Resources Manager", "Project Manager", "Sales Representative",
    "Customer Success Manager", "Data Resume Scientist", "Web Developer", "IT Consultant",
    ...
    "Data Resume Analyst", "Operations Manager", "Technical Writer", "Brand Strategist",
...
experiences = [
    ...
    "Performed data analysis at Oracle for 2 years as a Data Resume Analyst to drive business decision-making.",
...
educations = [
    ...
    "Master's Degree in Data Resume Science, Stanford University, Graduated August 2022",
...
certifications = [
    ...
    "Data Resume Science Certification, Microsoft, 2022",
    ...
    "Certified Data Resume Scientist, Data Resume Science Council of America (DASCA), 2018"
]
...
skills = [
    ...
    "Data Resume Analysis: Experienced in collecting, processing, and interpreting data to extract valuable insights and inform decision-making processes",
    ...
    "Data Resume Visualization (e.g., Tableau, Power BI): Experienced in using data visualization tools such as Tableau and Power BI to create interactive and informative visualizations from large datasets",
